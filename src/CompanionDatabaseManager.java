...
public class CompanionDatabaseManager {
    private static final Logger logger = Logger.getLogger(CompanionDatabaseManager.class.getName());
    ...
    public static boolean saveReport(CompanionReportData data) {
        ...
        String sql = "INSERT INTO reports (" +
            ...
            "time_string, id_number, employer_arabic, license_number, kinship_arabic, kinship_english, user_id" +
            ") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
            ...
            stmt.setString(24, data.kinshipArabic());
            stmt.setString(25, data.kinshipEnglish());
            stmt.setInt(26, UserSession.getInstance().getUserId());
            ...
            Platform.runLater(() -> {
                ...
                alert.setHeaderText("SQL Error Details");

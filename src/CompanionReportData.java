...
public class CompanionReportData {
    ...
    private final String kinshipArabic;
    private final String kinshipEnglish;

    public CompanionReportData(
        String reportID,
        String nameArabic,
        String nameEnglish,
        String doctorArabic,
        ...
        String kinshipArabic,
        String kinshipEnglish
    ) {
        ...
        this.kinshipArabic = kinshipArabic;
        this.kinshipEnglish = kinshipEnglish;
    }
    ...
    public String kinshipArabic() { return kinshipArabic; }
    public String kinshipEnglish() { return kinshipEnglish; }
}